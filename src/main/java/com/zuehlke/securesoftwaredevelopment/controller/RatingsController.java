...
public class RatingsController {
    ...
    public String createOrUpdateRating(@RequestBody Rating rating, Authentication authentication) {
        ...
        LOG.info("Korisnik sa id-jem " + user.getId() + " je azurirao/uneo ocenu " + rating.getRating() + " za film sa id-jem " + rating.getMovieId());
        AuditLogger.getAuditLogger(DatabaseAuthenticationProvider.class).audit("Menjanje ocene za film " + rating.getMovieId());
