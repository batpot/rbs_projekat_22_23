...
public class PersonRepository {
    ...
    public List<Person> getAll() {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Nije uspelo izvrsavanje upita za izlistavanje svih osoba.", e);
        }
        return personList;
    }
    ...
    public List<Person> search(String searchTerm) throws SQLException {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Nije uspela pretraga korisnika: " + searchTerm, ex);
        }
        return personList;
    }
    ...
    public Person get(String personId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Nije uspelo pronalazenje korisnika sa id-jem " + personId, ex);
        }
    ...
    public void delete(int personId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Nije uspelo brisanje korisnika sa id-jem " + personId, ex);
            AuditLogger.getAuditLogger(DatabaseAuthenticationProvider.class).audit("Nije uspelo brisanje korisnika " + personId);
        }
    }
    ...
    public void update(Person personUpdate) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Nije uspelo azuriranje korisnika sa id-jem " + personUpdate.getId(), e);
            AuditLogger.getAuditLogger(DatabaseAuthenticationProvider.class).audit("Nije uspelo azuriranje korisnika " + personUpdate.getId());
        }
    }
}
