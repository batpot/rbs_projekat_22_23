...
public class MovieRepository {
    ...
    public List<Movie> getAll() {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Nije uspelo izlistavanje svih filmova.", e);
        }
        return movieList;
    }
    ...
    public List<Movie> search(String searchTerm) throws SQLException {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Nije uspela pretraga filma: " + searchTerm, ex);
        }
        return movieList;
    }
    ...
    public Movie get(int movieId, List<Genre> genreList) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            LOG.warn("Nije uspelo izvrsavanje upita za pretragu filma sa id-jem: " + movieId, e);
        }
            ...
            if (generatedKeys.next()) {
                ...
                genresToInsert.stream().forEach(genre -> {
                    ...
                    try (PreparedStatement statement2 = connection.prepareStatement(query2);
                        ...
                        LOG.warn("Nije uspelo dodeljivanje zanra filmu", e);
                    }
                });
            }
        } catch (SQLException e) {
            LOG.warn("Nije uspelo kreiranje filma.", e);
        }
        return id;
    }
    ...
    public void delete(int movieId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            AuditLogger.getAuditLogger(DatabaseAuthenticationProvider.class).audit("Nije uspelo brisanje filma " + movieId);
        }
    }
